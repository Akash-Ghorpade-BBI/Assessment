...
class HomeScreenGuidelinesModel extends HomeScreenData {
  HomeScreenGuidelinesModel(
      {int? id,
        String? categoryName,
  ...
  factory HomeScreenGuidelinesModel.fromJson(Map<String, dynamic> json) {
    var items;
    if (json['items'] != null) {
      items = <ItemsModel>[];
    ...
    var subCategory = json['subCategory'] != null
        ...
        : null;
    return HomeScreenGuidelinesModel(
      id: json['id'],
      items: items,
